...
Verify that a Windows version of Python 3.8, 3.9, and/or 3.10 is installed.

2. Installing the testFun Package

A. Change to the directory that contains the file setup.py and the subdirectory testFun. 
...
3. Using the testFun Package

The testFun package is on your Python path. To import it into a Python script or session, 
execute:
